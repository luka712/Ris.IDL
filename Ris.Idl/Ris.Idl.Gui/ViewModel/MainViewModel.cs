...
public partial class MainViewModel : BaseViewModel
{
    ...
    private async Task GenerateFullProjectAsync(ProjectLoader loader, string projectName)
    {
        ...
        // Write to disk
        AProjectGenerator aProjectGenerator = new TypeScriptProjectGenerator();
        await Task.Run(() => aProjectGenerator.WriteProjectAsync(project));
    ...
    private async Task GenerateIdlOnlyAsync(ProjectLoader loader, string projectName)
    {
        ...
        var idlProject = await Task.Run(() => loader.LoadProjectAsync(ProjectPath!, configuration.GeneratorConfig));
        ...
        var project = await projectGenerator.GenerateProjectAsync(configuration, files);
