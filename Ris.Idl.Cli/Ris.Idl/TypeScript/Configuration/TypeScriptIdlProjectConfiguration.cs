...
/// </summary>
public class TypeScriptIdlProjectConfiguration : IdlProjectConfiguration
{
    public TypeScriptIdlProjectConfiguration()
    {
        GeneratorConfig = new TypeScriptConfig
        {
            // IDL projects generate interfaces only, without src folder structure
            SourceFolderPrefix = null
        };
    }
